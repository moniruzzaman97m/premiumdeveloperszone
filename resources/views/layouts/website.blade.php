...
<head>
  ...
  <!-- Google Fonts -->
  <link href="{{ asset('website') }}/https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Raleway:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <!-- <a href="index.html" class="logo mr-auto"><img src="{{ asset('website') }}/assets/img/logo.png" alt=""></a>-->
    ...
    <section id="clients" class="clients">
      <div class="container" data-aos="zoom-in">
        <div class="owl-carousel clients-carousel">
          <img src="{{ asset('website') }}/assets/img/clients/client-1.png" alt="">
          <img src="{{ asset('website') }}/assets/img/clients/client-2.png" alt="">
          <img src="{{ asset('website') }}/assets/img/clients/client-3.png" alt="">
          <img src="{{ asset('website') }}/assets/img/clients/client-4.png" alt="">
          <img src="{{ asset('website') }}/assets/img/clients/client-5.png" alt="">
          <img src="{{ asset('website') }}/assets/img/clients/client-6.png" alt="">
          <img src="{{ asset('website') }}/assets/img/clients/client-7.png" alt="">
          <img src="{{ asset('website') }}/assets/img/clients/client-8.png" alt="">
        </div>
      </div>
        ...
        <div class="tab-content">
          <div class="tab-pane active show" id="tab-1">
            <div class="row">
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center" data-aos="fade-up" data-aos-delay="200">
                <img src="{{ asset('website') }}/assets/img/tabs-1.jpg" alt="" class="img-fluid">
              </div>
            </div>
          </div>
          <div class="tab-pane" id="tab-2">
            <div class="row">
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center">
                <img src="{{ asset('website') }}/assets/img/tabs-2.jpg" alt="" class="img-fluid">
              </div>
            </div>
          </div>
          <div class="tab-pane" id="tab-3">
            <div class="row">
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center">
                <img src="{{ asset('website') }}/assets/img/tabs-3.jpg" alt="" class="img-fluid">
              </div>
            </div>
          </div>
          <div class="tab-pane" id="tab-4">
            <div class="row">
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center">
                <img src="{{ asset('website') }}/assets/img/tabs-4.jpg" alt="" class="img-fluid">
              </div>
            </div>
          </div>
        </div>
